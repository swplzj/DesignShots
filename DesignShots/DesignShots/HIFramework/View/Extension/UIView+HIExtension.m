...
@implementation UIView (HIExtension)

#pragma mark - 

UIInterfaceOrientation HI_InterfaceOrientation() {
    UIInterfaceOrientation orient = [UIApplication sharedApplication].statusBarOrientation;
    return orient;
}

CGRect HI_ScreenBounds() {
    CGRect bounds = [UIScreen mainScreen].bounds;
    if (UIInterfaceOrientationIsLandscape(HI_InterfaceOrientation())) {
...
- (CGFloat)orientationWidth {
    return UIInterfaceOrientationIsLandscape(HI_InterfaceOrientation())
