...
@implementation UIImage (HIExtension)
...
- (UIImage *)blurryImage:(UIImage *)image withBlurLevel:(CGFloat)blur
{
    ...
    int nbitmapInfo = kCGBitmapByteOrderDefault | kCGImageAlphaPremultipliedLast;
#else
    int nbitmapInfo = kCGImageAlphaPremultipliedLast;
#endif
...
{
    return [self resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10) resizingMode:UIImageResizingModeTile];
}
