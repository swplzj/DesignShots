//
//  HIUINavigationNotificationView.m
//  HIFramework
//
...
@interface HIUINavigationGradientView : UIView {
}
...
@implementation HIUINavigationGradientView
...
@interface HIUINavigationNotificationWindow : UIWindow
...
@implementation HIUINavigationNotificationWindow
...
- (void) willRotateScreen:(NSNotification *)notification
{
    ...
    CGRect notificationBarFrame = [HIUINavigationNotificationWindow notificationRectWithOrientation:orientation];
...
static HIUINavigationNotificationWindow * __notificationWindow = nil;

@interface HIUINavigationNotificationView ()
...
@implementation HIUINavigationNotificationView
...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CGFloat notificationWidth = [HIUINavigationNotificationWindow notificationRectWithOrientation:orientation].size.width;
        
        self.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        
        _contentView = [[HIUINavigationGradientView alloc] initWithFrame:self.bounds];
        ...
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(6, self.center.y-28/2, 28, 28)];
        ...
        CGRect textFrame = CGRectMake(__imagePadding + CGRectGetMaxX(_imageView.frame),
                                      (self.frame.size.height - textFont.lineHeight-detailFont.lineHeight)/2,
                                            ...
                                            duration:(NSTimeInterval)duration
{
    if (__notificationWindow == nil) {
        UIInterfaceOrientation orientation = [UIApplication sharedApplication].statusBarOrientation;
        CGRect frame = [HIUINavigationNotificationWindow notificationRectWithOrientation:orientation];
        __notificationWindow = [[HIUINavigationNotificationWindow alloc] initWithFrame:frame];
        __notificationWindow.hidden = NO;
    }
    CGRect bounds = __notificationWindow.bounds;
    HIUINavigationNotificationView * notification = [[HIUINavigationNotificationView alloc] initWithFrame:bounds];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:HIUINavigationNofiticationTapReceivedNotification
                                                        object:self];
    ...
    [HIUINavigationNotificationView showNextNotification];
}
...
+ (void) showNextNotification
{
    ...
    if ([viewToRotateIn isKindOfClass:[HIUINavigationNotificationView class]] ) {
    ...
    [UIView animateWithDuration:0.5
                     ...
                     completion:^(BOOL finished) {
                         ...
                         if ([viewToRotateIn isKindOfClass:[HIUINavigationNotificationView class]]) {
                             HIUINavigationNotificationView *notification = (HIUINavigationNotificationView *)viewToRotateIn;
