...
#import "NSString+HIExtension.h"

@implementation NSString (HIExtension)
@dynamic data;
@dynamic date;
...
{
    if (HI_NSSTRING_IS_INVALID(string)) {
        return self;
    }
...
-(NSStringValidBlock)VALID
{
    NSStringValidBlock block = ^ BOOL (){
        ...
        return !HI_NSSTRING_IS_INVALID(self);
    };
...
@implementation NSMutableString (HIExtension)
